...
# Still need to figure out the discrepency between DaPrato and Walsh 
...
# Make a movie to illustrate simulations of the Sheet
# See comment in the BrownianSheetMovie function to distinguish between the Walsh sheet and the Daprato sheet
